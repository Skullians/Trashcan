        ...
        for (Class<?> clazz : classes) {
            ...
            if (ignoreAutoScan == null) {
                try {
                    ...
                    options.getLogger().log(Level.WARNING, "An exception was thrown during injection", e);
                }
            }
        }
    }
        ...
        for (Map.Entry<Class<?>, Object> entry : services.entrySet()) {
            ...
            long milli = tracked(() -> close.ifPresent(it -> {
                try {
                    ...
                    options.getLogger().log(Level.SEVERE, "An exception was thrown while closing service - {}", e);
                }
            }));
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if (field.isAnnotationPresent(Inject.class)) {
                ...
                try {
                    ...
                    options.getLogger().log(Level.SEVERE, "An exception was thrown while injecting field - {}", e);
                }
            }
        }
